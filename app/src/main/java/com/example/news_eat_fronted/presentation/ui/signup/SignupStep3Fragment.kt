...
class SignupStep3Fragment: BindingFragment<FragmentSignupStep3Binding>(R.layout.fragment_signup_step3) {
    val categoryList = listOf(
        CategoryItem(1, R.drawable.category_politics_unselected, R.string.category_politics),
        CategoryItem(2, R.drawable.category_economy_unselected, R.string.category_economy),
        CategoryItem(3, R.drawable.category_social_unselected, R.string.category_social),
        CategoryItem(4, R.drawable.category_culture_unselected, R.string.category_culture),
        CategoryItem(5, R.drawable.category_science_unselected, R.string.category_science),
        CategoryItem(6, R.drawable.category_entertainment_unselected, R.string.category_entertainment),
        CategoryItem(7, R.drawable.category_sports_unselected, R.string.category_sports),
        CategoryItem(8, R.drawable.category_world_unselected, R.string.category_world),
    )
